...
namespace SecretSharing.ProfilerRunner
{
    static class Program
    {
        ...
        {
            AccessStructure acc = new AccessStructure("p1^p2^p3,p2^p3^p4,p1^p3^p4,p1^p2^p4,p4^p5^p6,p4^p5^p7,p4^p6^p7");//"P1^P2,P2^P3,P3^p4,p3^p5,p3^p6,p6^p7,p7^p8,p8^p1");
